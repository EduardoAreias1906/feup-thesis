...
\begin{itemize}
    ...
    %% FEEDBACK INTEGRATION: Explicitly allowing high-impact institutional reports to justify the inclusion of Molnar (NEPC).
    \item \textbf{EC2} -- The publication type is a thesis, dissertation, blog post, or other non-peer-reviewed document (with the exception of high-impact institutional reports, such as the NEPC annual report).
...
To provide an overview of the state-of-the-art, Table~\ref{tab:lit_summary} summarizes the key papers selected for the final corpus.
...
Beck (2023, 2024) & Empirical & At-Risk Students & At-risk students perform better with substantial ``advocate'' support. \\ \hline
...
Large-scale reports consistently highlight performance gaps~\cite{molnar_virtual_2023}, noting lower graduation rates.
...
An important finding is that the demographic profile of virtual schools differs significantly from traditional ones.
...
Beck and Levine~\cite{beck_advocate_2020} found that parental engagement was a substantial predictor of success than many course-level variables during the pandemic.

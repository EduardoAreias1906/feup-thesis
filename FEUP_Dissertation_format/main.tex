...
%% MEIC working version — enables numeric citations and MEIC degree title
...
%% url, setspace, makeidx, graphicx, xcolor, float, acronym, etc (see README)

%% Include here any other packages you need

%% Fix: override typewriter font to Computer Modern Typewriter.
%% feupteses expects Courier (couriers.sty), but its TFM metrics are absent
%% from the basic TeX Live distribution. cmtt prevents nullfont errors.
\renewcommand{\ttdefault}{cmtt}

%% Sort the bibliography alphabetically by author (Name, Year, Title).
%% The [meic] option above loads style=numeric-comp via feupteses.sty;
%% \ExecuteBibliographyOptions lets us override the sort order afterward.
...
%% Degree / Programme (override the feupteses.sty default)
...
%% Copyright notice
\copyrightnotice{Eduardo Salé Areias, \the\year{}}

\supervisor{Supervisor}{Prof.\ Fernando Cassola Marques}

%% Co-supervisor
\supervisor{Second Supervisor}{Prof.\ Dennis Beck}

%% Committee members — fill in for juri/final versions
%\committeetext{Approved in oral examination by the committee:}
%\committeemember{President}{}
%\committeemember{Examiner}{}
...
\include{body/01_thesis_manifest}
\include{body/02_literature_review}
\include{body/03_state_of_the_art}
\include{body/04_methodology}
\include{body/05_results}
\include{body/06_discussion}
\include{body/07_conclusion}

...
\begin{enumerate}
  \item[\textbf{RQ1}] \textbf{Identification.} Which \emph{virtual choreographies} (recurring sequences of online learning actions) can be reliably discovered in synthetic activity data modeling a fully online K-12 environment using unsupervised clustering, and how stable are they over time?

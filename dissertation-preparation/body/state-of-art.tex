\chapter{State of Art} \label{chap:stateofart}

Lorem ipsum dolor sit amet, consectetuer adipiscing elit. 
Donec a eros. Phasellus non nulla non massa venenatis convallis. 
In porta. Mauris quis magna. 

\section{Introduction}

\citet{kn:MVL06-xata} fusce risus mi, tristique eu, consectetuer 
id, auctor sed, elit. Donec laoreet. Duis consectetuer interdum 
libero.
...
hendrerit sed, urna~\citep{kn:svgdoc}.

Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec a eros. 
\citet{kn:svgibm,kn:svgw3c} phasellus non nulla non massa venenatis convallis. 
In porta. Mauris quis magna.
...
imperdiet nec, lacus \textit{applets}~\citep{kn:batik}. 

Curabitur in elit sed sem rutrum posuere. Class aptent taciti 
sociosqu ad litora torquent per conubia nostra, per
inceptos himenaeos~\citep{kn:svgdoc}. 
